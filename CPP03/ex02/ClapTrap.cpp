...
/*   Updated: 2025/01/08 08:14:48 by acaffard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string& target)
{
	if (!_hitpoints)
	{
		std::cout << "ClapTrap " << _name << " is completely broken and cannot attack " << target << std::endl;
		return ;
	}
	if (!_energypoints)
	{
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << _name << " takes " << amount << " damage leaving it to " << _hitpoints << " hitpoints" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (!_hitpoints)
	{
		std::cout << _name << " is completely broken and cannot repair itself "<< std::endl;
		return ;
	}
	if (!_energypoints)
	{
		std::cout << _name << " does not have enough energy to repair itself" << std::endl;
		return ;
	}
	std::cout << _name << " repairs itself of " << amount << " hitpoints" << std::endl;
	_energypoints--;
